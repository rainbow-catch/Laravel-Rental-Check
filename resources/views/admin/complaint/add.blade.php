            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="card">
                        ...
                        <div class="content">
                            {!! Form::open(array('url' => 'admin/membership/', 'id' => 'membership-add-form')) !!}
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="membership" class="form-control border-input"
                                               placeholder="Ex: Days late" value="{{ Input::old('membership') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info btn-fill btn-wd">Add membership</button>
                            </div>
