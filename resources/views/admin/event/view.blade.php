            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="content">
                            <div class="toolbar">
                                <a href="{{url('admin/event/create')}}" rel="tooltip" title="Add New Event"
                                                ...
                                                <td>
                                                    <div class="table-icons">
                                                        <a rel="tooltip" title="Edit"
                                                           ...
                                                           href="{{url('admin/event/'.$event->id.'/edit')}}">
                                                        ...
                                                        <div class="collapse">
                                                            {!! Form::open(array('id' => 'delete-event', 'url' => 'admin/event/'.$event->id)) !!}
